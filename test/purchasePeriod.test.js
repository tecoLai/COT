...
contract('COTCoinCrowdsale', function ([owner, purchaser, purchaser2, purchaser3, purchaser4, purchaser5, purchaser6, purchaser7]) {
  const wallet = owner;
  ...
  describe('accepting payments', function () {
    it('owner can not buy token after premium sale-start', async function () {
